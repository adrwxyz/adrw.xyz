...
- Techniques for Raising Autonomous Children
  ...
  * Visit [letgrow.org](http://letgrow.org) for tips to raise resilient children. Simplest idea: print out a *Let Grow Licence* that children can carry with them in case they are stopped by busybody's or police who question whether they are allowed to be out on their own. License essentially acts as a parental permission form and reminder that independent children is lawful and not a form of neglect.
